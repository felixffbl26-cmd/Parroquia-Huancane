...
def cargar_datos():
    ...
    try:
        # Intentar ruta relativa primero (para Streamlit Cloud)
        import os
        ruta_base = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
        ruta_csv = os.path.join(ruta_base, "datos_consolidados.csv")
        ...
        st.info(f"📁 Buscando en: {ruta_csv if 'ruta_csv' in locals() else 'ruta no definida'}")
        return None
